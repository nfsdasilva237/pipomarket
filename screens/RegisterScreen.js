// screens/RegisterScreen.js - VERSION SIMPLIFIÉE (SANS STARTUP)
        ...
        >
          ...
          <View style={styles.accountTypeSection}>
            ...
            <View style={styles.startupInfo}>
              <Text style={styles.startupInfoIcon}>🏢</Text>
              <Text style={styles.startupInfoText}>
                Vous êtes une startup ? Connectez-vous avec le code d'accès fourni par l'administrateur.
              </Text>
            </View>
          </View>
            ...
            >
              {loading ? (
                <View style={styles.loadingContainer}>
                  ...
                  <Text style={styles.loadingText}>Création...</Text>
                </View>
              ) : (
                <>
