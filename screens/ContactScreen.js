        ...
        <View style={styles.directContact}>
          ...
          <View style={styles.contactCard}>
            ...
            <View style={styles.contactInfo}>
              ...
              <Text style={styles.contactValue}>+237 620 70 29 01</Text>
            </View>
          </View>
          ...
          <View style={styles.contactCard}>
            ...
            <View style={styles.contactInfo}>
              ...
              <Text style={styles.contactValue}>bdlstudio03@gmail.com</Text>
            </View>
          </View>
          ...
          <View style={styles.contactCard}>
            ...
            <View style={styles.contactInfo}>
              ...
              <Text style={styles.contactValue}>Yaoundé, Cameroun</Text>
            </View>
          </View>
        </View>
